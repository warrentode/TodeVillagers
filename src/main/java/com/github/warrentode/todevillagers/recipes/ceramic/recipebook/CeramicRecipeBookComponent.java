...
public class CeramicRecipeBookComponent extends RecipeBookComponent {
    protected static final ResourceLocation RECIPE_BOOK_BUTTONS = new ResourceLocation(MODID, "textures/gui/ceramic_recipe_book_buttons.png");
    ...
    protected Component getRecipeFilterName() {
        return Component.translatable("container.recipe_book.ceramic");
    }
