...
public class GlassKilnFuelSlot extends SlotItemHandler {
    public GlassKilnFuelSlot(ContainerData kilnBlockData, IItemHandler itemHandler, int index, int x, int y) {
