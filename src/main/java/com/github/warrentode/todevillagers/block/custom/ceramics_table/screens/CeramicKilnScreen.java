...
import com.github.warrentode.todevillagers.recipes.ceramic.recipebook.CeramicRecipeBookComponent;
...
public class CeramicKilnScreen extends AbstractContainerScreen<CeramicKilnMenu> implements RecipeUpdateListener {
    ...
    private final CeramicRecipeBookComponent recipeBookComponent = new CeramicRecipeBookComponent();
    private boolean widthTooNarrow;

    public CeramicKilnScreen(CeramicKilnMenu menu, Inventory inventory, Component component) {
