...
public class CeramicKilnResultSlot extends SlotItemHandler {
    public final CeramicTableBlockEntity kilnBlockEntity;
    private final Player player;
    private int removeCount;

    public CeramicKilnResultSlot(Player player, CeramicTableBlockEntity kilnBlockEntity, IItemHandler itemHandler, int index, int x, int y) {
