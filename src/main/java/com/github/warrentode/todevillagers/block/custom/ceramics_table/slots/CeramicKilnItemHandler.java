...
public class CeramicKilnItemHandler implements IItemHandler {
    ...
    public CeramicKilnItemHandler(IItemHandler handler, BiPredicate<Integer, ItemStack> insert, Predicate<Integer> extract, @Nullable Direction side) {
